...
class UserInfo(models.Model):
    ...
    depart = models.ForeignKey(verbose_name='部门', to="Department", to_field="code",on_delete=models.DEFERRED)
...
class ClassList(models.Model):
    ...
    """
    school = models.ForeignKey(verbose_name='校区', to='School',on_delete=models.DEFERRED)
    course = models.ForeignKey(verbose_name='课程名称', to='Course',on_delete=models.DEFERRED)
    ...
    tutor = models.ForeignKey(verbose_name='班主任', to='UserInfo', related_name='classes',limit_choices_to={"depart":1001},on_delete=models.DEFERRED)
...
class Customer(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name="课程顾问", to='UserInfo', related_name='consultanter',
                                   limit_choices_to={'depart_id': 1001},on_delete=models.DEFERRED)
...
class ConsultRecord(models.Model):
    ...
    客户跟进记录
    """
    customer = models.ForeignKey(verbose_name="所咨询客户", to='Customer',on_delete=models.DEFERRED)
    consultant = models.ForeignKey(verbose_name="跟踪人", to='UserInfo',on_delete=models.DEFERRED)
...
class Student(models.Model):
    ...
    学生表（已报名）
    """
    customer = models.OneToOneField(verbose_name='客户信息', to='Customer',on_delete=models.DEFERRED)
...
class CourseRecord(models.Model):
    ...
    上课记录表 （班级记录）
    """
    class_obj = models.ForeignKey(verbose_name="班级", to="ClassList",on_delete=models.DEFERRED)
    day_num = models.IntegerField(verbose_name="节次", help_text=u"此处填写第几节课或第几天课程...,必须为数字")
    teacher = models.ForeignKey(verbose_name="讲师", to='UserInfo',limit_choices_to={"depart_id__in":[1002,1003]},on_delete=models.DEFERRED)
...
class StudyRecord(models.Model):
    ...
    学生记录
    '''
    course_record = models.ForeignKey(verbose_name="第几天课程", to="CourseRecord",on_delete=models.DEFERRED)
    student = models.ForeignKey(verbose_name="学员", to='Student',on_delete=models.DEFERRED)
